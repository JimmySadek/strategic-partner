# Fixture for tests/lint-voice-mirror.sh self-test (run via --root). Minimal: the two declarations plus the lint's anchor phrases.

SKILL.md is the canonical source of SP's voice rules.
